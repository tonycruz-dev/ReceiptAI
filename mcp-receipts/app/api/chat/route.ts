...
import { buildForcedToolCallsFromActionPayload } from "@/lib/server/chat/action-router";
import { buildForcedToolCallsFromSelectedContext } from "@/lib/server/chat/selected-context-router";
import { ActionPayload, ChatMessage, CleanReceipt, ForcedToolCall, SelectedContext,} from "@/lib/server/chat/chat-types";
...
//     switch (selectedContext.name) {
//       case "receipts_this_month":
//         return [
//           buildForcedToolCall(
//             "mcp_read_resource",
//             { uri: "receipt://this-month" },
...
//       case "receipts_by_date":
//       case "receipts_by_date_range":
//       case "receipts_by_category":
//       case "receipt_by_id":
//       case "receipts_paged_resource":
//       case "receipts_paged_tool":
//       case "create_receipt_from_image":
//         return [
//           buildForcedToolCall(
//             "mcp_get_prompt",
